        ...
        <div className="contact-content">
          ...
          <div className="contact-form" data-aos="fade-up" data-aos-delay="750">
            <div>
              ...
              <p>
                Have a question? Need to book a service? We're here to help. At
                Supper Range Car Service Center, our friendly team is ready to
                assist you with all your automotive needs. Whether it's routine
                maintenance, emergency support, or expert advice just reach out
            ...
            <div className="content">
              <div className="ak-section-heading ak-style-1">
                ...
                <p className="ak-section-subtitle">
                  Have a question? Need to book a service? We're here to help.
                  At Supper Range Car Service Center, our friendly team is ready
                  to assist you with all your automotive needs. Whether it's
                  routine maintenance, emergency support, or expert advice just
          ...
          <div className="right-info">
              ...
              <div className="d-flex gap-2 ">
                ...
                <div>
                  <p>
                    ...
                    <a
                      href="https://maps.app.goo.gl/NGC9emB97NkzawWp7"
                      target="_blank"
                  ...
                  <p>
                    ...
                    <a
                      href="https://maps.app.goo.gl/8y8tZgZ1AcLxgy2Y7"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      View on Google Maps
            ...
            <div className="info-card" data-aos="fade-left">
              ...
              <div className="d-flex gap-2 align-items-center">
                ...
                <div>
                  <p>
                    <strong>Sharjah:</strong> +971-56-484 6499
                  </p>
                  <p>
                    <strong>Al Ain:</strong> +971-55-710 8899
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="d-flex gap-2 align-items-center">
                <div className="mb-1">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M11.833 10.4502L10.1934 12.4999H11.833V10.4502Z"
                      fill="white"
                    />
                    <path
                ...
                <div>
                  <p>
                    Saturday–Thursday: 9:00 AM – 1:00 PM
                    <br />
            ...
            <div className="info-card" data-aos="fade-left">
              ...
              <div className="d-flex gap-3 align-items-center">
                <a
                  href="https://www.instagram.com/p/DJOMHR3hhxF/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href="https://www.facebook.com/p/Super-Range-Car-Service-Center-61559480229353/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-icon"
                >
