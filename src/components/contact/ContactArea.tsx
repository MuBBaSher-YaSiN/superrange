        ...
        <div className="contact-content">
            ...
            <div className="contact-form" data-aos="fade-up" data-aos-delay="750">
                <div>
                    ...
                    <p>Have a question? Need to book a service? We're here to help. At Supper Range Car Service Center, our friendly team is ready to assist you with all your automotive needs. Whether it's routine maintenance, emergency support, or expert advice just reach out and we'll take care of the rest.</p>
            ...
            <div className="left-info" data-aos="fade-right">
                <div className="content">
                    <div className="ak-section-heading ak-style-1">
                        ...
                        <p className="ak-section-subtitle">Have a question? Need to book a service? We're here to help. At Supper Range Car Service Center, our friendly team is ready to assist you with all your automotive needs. Whether it's routine maintenance, emergency support, or expert advice just reach out and we'll take care of the rest.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="right-info">
                ...
                <div className="info-card" data-aos="fade-left">
                    ...
                    <div className="d-flex gap-2 ">
                        ...
                        <div>
                            <p><strong>Sharjah Branch:</strong> <br /><a href="https://maps.app.goo.gl/NGC9emB97NkzawWp7" target="_blank" rel="noopener noreferrer">View on Google Maps</a></p>
                            <p><strong>Al Ain Branch:</strong> <br /><a href="https://maps.app.goo.gl/8y8tZgZ1AcLxgy2Y7" target="_blank" rel="noopener noreferrer">View on Google Maps</a></p>
                        </div>
                    </div>
                </div>
                <div className="info-card" data-aos="fade-left">
                    ...
                    <div className="d-flex gap-2 align-items-center">
                        ...
                        <div>
                            <p><strong>Sharjah:</strong> +971-56-484 6499</p>
                            <p><strong>Al Ain:</strong> +971-55-710 8899</p>
                        </div>
                    </div>
                </div>
                <div className="info-card" data-aos="fade-left">
                    ...
                    <div className="d-flex gap-2 align-items-center">
                        ...
                        <div>
                            <p>Saturday–Thursday: 9:00 AM – 1:00 PM<br />Evening 4:00 PM – 10:00 PM</p>
                            <p>Friday: Closed</p>
                        </div>
                    </div>
                </div>
                <div className="info-card" data-aos="fade-left">
                    ...
                    <div className="d-flex gap-3 align-items-center">
                        <a href="https://www.instagram.com/p/DJOMHR3hhxF/" target="_blank" rel="noopener noreferrer" className="social-icon">
                        ...
                        <a href="https://www.facebook.com/p/Super-Range-Car-Service-Center-61559480229353/" target="_blank" rel="noopener noreferrer" className="social-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white">
